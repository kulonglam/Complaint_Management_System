...
public class SecurityConfig {
    ...
    public SecurityConfig(AppProperties appProperties, SupabaseAuthFilter supabaseAuthFilter) {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/health", "/api/jobs/**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.stream(appProperties.getCorsOrigins().split(","))
                .map(String::trim)
